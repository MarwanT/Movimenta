...
extension FontBook {
  fileprivate static var fontLineHeightTable: [String: [UIContentSizeCategory:CGFloat]] = [
    ...
    FontBook.title4.rawValue: [
      UIContentSizeCategory.accessibilityExtraExtraExtraLarge: 32,
      UIContentSizeCategory.accessibilityExtraExtraLarge: 32,
      UIContentSizeCategory.accessibilityExtraLarge: 32,
      UIContentSizeCategory.accessibilityLarge: 32,
      UIContentSizeCategory.accessibilityMedium: 32,
      UIContentSizeCategory.extraExtraExtraLarge: 32,
      UIContentSizeCategory.extraExtraLarge: 30,
